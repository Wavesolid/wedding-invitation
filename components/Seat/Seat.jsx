...
export default function Seat({props})
{
    ...
    return (
        <div className="h-screen bg-merah flex flex-col items-center justify-center">
            ...
            <div>
                <span className="text-putih text-[24px]">Total Souvenir : {totalSouvenir}</span>
            </div>
            <div className='rounded-lg bg-merah p-[24px] my-0 mx-auto flex items-center justify-center text-putih'>
                <div>Tunjukan barcode ini ke penerima tamu untuk mengkonfirmasi kehadiran anda</div>
