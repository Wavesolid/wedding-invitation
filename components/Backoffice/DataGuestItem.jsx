    ...
    return(
        <tr>
            ...
            <td className="px-6 py-4 whitespace-nowrap text-center">
                <a className="text-indigo-600 hover:text-indigo-900" target="_blank" href={`https://api.whatsapp.com/send?text=${waMsg}&phone=${guestEdit.waNumber}`}> {guestEdit.waNumber} </a>
            </td>
